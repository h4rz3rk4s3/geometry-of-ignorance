...
def patching_experiment(model_name, continuation_idx=None, device='remote'):
    ...
    false_prompt = toxic_prompt
    true_prompt = healthy_prompt
    ...
    # output = model.tokenizer.decode(output_ids)
    # print(output)
    ...
    # t_tok = model.tokenizer("Ġhealthy", add_special_tokens=False).input_ids
    # f_tok = model.tokenizer("Ġtoxic", add_special_tokens=False).input_ids
    t_tok = [9498] #healthy in the Phi-4 Tokenizer
    f_tok = [21503] #toxic in the Phi-4 Tokenizer
